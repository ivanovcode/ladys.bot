...
var messages_= (messages_?messages_: [
    '> Упс, Ошибка 404 - страница не найдена...',
    'Возможно, вы неправильно набрали URL.',
    'Или страница была удалена.',
    'Вернитесь на главную, Спасибо!'
]);

$(window).load(function() {

    (function() {
        var $animate, $container, $message, $paragraph, animate, initialise, scramble, delay=0;  messages = [];
